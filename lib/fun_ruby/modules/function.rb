...
module FunRuby
  module Modules
    ...
    module Function
      ...
      #   plus_2 = ->(x) { x + 2 }
      #
      #   curried = F::Modules::Function.compose(plus_2)
      #   curried.(2) # => 4
      #
      ...
      #
      #   # multiplying -> adding
      #   curried = F::Modules::Function.compose(plus_2, multiply_3)
      #
      #   curried.(2) # => 8
      #
      #   # adding ->  multiplying
      #   curried = F::Modules::Function.compose(multiply_3, plus_2)
      #
      #   curried.(2) # => 12
      #
      ...
      #   curried = F::Modules::Function.compose(mod_4, plus_2, multiply_3)
      #   curried.(4) # => 2
      ...
      #   plus_2 = ->(x) { x + 2 }
      #
      #   curried = F::Modules::Function.pipe(plus_2)
      #   curried.(2) # => 4
      #
      # @example Basic: two functions
      #   plus_2 = ->(x) { x + 2 }
      ...
      #
      #   # multiplying -> adding
      #   curried = F::Modules::Function.pipe(multiply_3, plus_2)
      #
      #   curried.(2) # => 8
      #
      #   # adding ->  multiplying
      #   curried = F::Modules::Function.pipe(plus_2, multiply_3)
      #
      #   curried.(2) # => 12
      #
      # @example Basic: three functions
      ...
      #
      #   # multiplying -> adding -> mod
      #   curried = F::Modules::Function.pipe(multiply_3, plus_2,  mod_4)
      #   curried.(4) # => 2
      ...
      #   curry = F::Modules::Function.curry
